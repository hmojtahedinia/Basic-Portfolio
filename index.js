$(document).ready(function() {
  ...
  var typed = new Typed("#typed", {
    strings: [
      ...
      "a <b><em>smart</em></b>  and <b><em>talented</em></b> developer..."
    ],
  ...
  $.ajax({
    ...
    url:
      "https://api.darksky.net/forecast/cdebfdd2f00f031e2ad5aea7c2cc18f5/43.6532,-79.3832?units=si",
    ...
    //console.log(temp);
    $("#weather").append(
      " " + temp + "&#x2103" + "<br>" + " " + data.currently.summary
    );
  });
});
